...
LOG_LINE_SCHEMATIZER_EXCEPTION = 'log_line.schematizer_exception'
...
class MetricsReporter(object):
    ...
    def __init__(self, backend, sample_rate=0):
        ...
        self._schematizer_exception_counter = _create_or_fake_counter(
            METRICS_TOTAL_PREFIX + LOG_LINE_SCHEMATIZER_EXCEPTION,
            default_dimensions
        )
    ...
    def schematizer_exception(self):
        """Increases the schematizer exception counter by 1"""
        with self._lock:
            self._schematizer_exception_counter.count(1)
